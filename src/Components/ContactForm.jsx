  ...
  return (
    <div className="cf-container">
      <div className="cf-row">
        <div className="cf-col col">
          <form className="cf-form needs-validation-contact" onSubmit={handleSubmit(onSubmit)}>
          <h2 className="cf-title">CONTACTATE CON NOSOTROS!</h2>
            <label>NOMBRE</label>
            <Controller
              name="nombre"
              control={control}
        ...
        <div className=" cf-coll cfm needs-validation-contact">
          <div className="cf-map map-container map">
